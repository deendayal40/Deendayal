...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002149727413') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002371733219') # request channel id ( make sure bot is admin ).
...
#Channel & Group link 
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+zfs14uAjnAs2NzFl')
